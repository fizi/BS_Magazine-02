...
{SETIMAGE: w=90&h=90&crop=1}
<div class="media-object comment-box-left pull-left">
  <div class="comment-icon">{GLYPH=fa-comments-o}</div>
  {TIMEDATE}
</div>	
<div class="media-body comment-box-right">
	<div class="row">				
		<div class="comment-box-username col-xs-6">'.LAN_THEME_8.'{USERNAME}</div>
		<div class="comment-box-reply col-xs-6 text-right">{REPLY}</div>
	</div>	
	<div class="row">
	...
	<div class="row">
		<div class="comment-status col-sm-12 col-md-6">{COMMENT_STATUS}</div>
			<div class="comment-moderate col-sm-12 col-md-6 text-right">{COMMENT_RATE} {COMMENTEDIT} {COMMENT_MODERATE}</div>
	</div>
</div>
';
