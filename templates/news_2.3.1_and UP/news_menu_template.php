...
$NEWS_MENU_TEMPLATE['latest']['item'] = '
  ...
  <li class="media">
    ...
    <div class="media-body">
      ...
      <div class="news-info">{NEWS_DATE=M dd, yyyy}&nbsp;&nbsp;&nbsp;{GLYPH=fa-comments}&nbsp;{NEWS_COMMENT_COUNT}&nbsp;&nbsp;&nbsp;{GLYPH=eye-open}&nbsp;{HITS_UNIQUE}</div>
    </div>
  </li>';
...
$NEWS_MENU_TEMPLATE['other']['item'] = '
    <div class="item {ACTIVE}">
      ...
      <h3>{NEWSTITLE}</h3>
      <p>{NEWSSUMMARY}</p>
      <p class="text-right"><a class="btn btn-primary btn-othernews" href="{NEWSURL}">{LAN=READ_MORE} &raquo;</a></p>
    </div>';						
...
$NEWS_MENU_TEMPLATE['other2']['item'] = "
  <li class='media'>
		...
		<div class='media-body'>
      <h4>{NEWSTITLELINK}</h4>
		  <p class='text-right'><a class='btn btn-primary btn-othernews2' href='{NEWSURL}'>{LAN=READ_MORE} &raquo;</a></p>
	  </div>
  </li>\n";
