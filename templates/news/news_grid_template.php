      ...
      <div class="col-md-6 featured-item">
        ...
        <div class="news-image">
          ...
          <div class="news-header">
            ...
            <div class="news-info">{GLYPH=fa-comments}&nbsp;{NEWS_COMMENT_COUNT}&nbsp;&nbsp;&nbsp;{GLYPH=eye-open}&nbsp;{HITS_UNIQUE}<span class="news-readmore pull-right"><a href="{NEWSURL}">'.LAN_READ_MORE.'&nbsp;&nbsp;<i class="fa fa-long-arrow-right"></i></a></span></div> 
          </div> 
        </div>                             
      </div>  
  ...
  //  fizi - This News Grid for 2. category's news id=2 (example: politics in test site) OK
	...
	$NEWS_GRID_TEMPLATE['news-grid-1']['item'] = '
      <div class="col-sm-6 item">
            ...
            <div class="news-info">{GLYPH=fa-comments}&nbsp;{NEWS_COMMENT_COUNT}&nbsp;&nbsp;&nbsp;{GLYPH=eye-open}&nbsp;{HITS_UNIQUE}<span class="news-readmore readmore-{NEWS_CATEGORY_ID} pull-right"><a href="{NEWSURL}">'.LAN_READ_MORE.'&nbsp;&nbsp;<i class="fa fa-long-arrow-right"></i></a></span></div>
					</div>
        </div>
      </div>';
	...
	$NEWS_GRID_TEMPLATE['news-grid-10']['item'] = '            
      <div class="col-sm-3">
        <div class="item">
          ...
          <div class="news-info pull">{GLYPH=fa-comments}&nbsp;{NEWS_COMMENT_COUNT}&nbsp;&nbsp;&nbsp;{GLYPH=eye-open}&nbsp;{HITS_UNIQUE}<span class="news-readmore readmore-{NEWS_CATEGORY_ID} pull-right"><a href="{NEWSURL}">'.LAN_READ_MORE.'&nbsp;&nbsp;<i class="fa fa-long-arrow-right"></i></a></span></div>
				</div>
      </div>';
