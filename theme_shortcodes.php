...
-----------------------------*/ 
  ...
  function sc_bootstrap_grid_news_cat_2(){
  
    $template = "
        <!-- News Grid Menu for category id=2 -->
        {MENU: path=news/news_grid&limit=6&category=2&source=latest&featured=2&layout=news-grid-1}
  ...
  function sc_bootstrap_grid_news_cat_3(){
  ...
  function sc_bootstrap_grid_news_cat_4(){
  ...
  function sc_bootstrap_grid_news_cat_5(){
  
    $template = "
        <!-- News Grid Menu for category id=5 -->
        {MENU: path=news/news_grid&limit=4&category=5&source=latest&featured=0&layout=news-grid-10}
  ...
  function sc_bootstrap_grid_news_cat_6(){
  
    $template = "
        <!-- News Grid Menu for category id=6 -->
        {MENU: path=news/news_grid&limit=3&category=6&source=latest&featured=1&layout=news-grid-3}
  ...
  function sc_bootstrap_grid_news_cat_7(){
  
    $template = "
        <!-- News Grid Menu for category id=7 -->
        {MENU: path=news/news_grid&limit=3&category=7&source=latest&featured=0&layout=news-grid-6}
  ...
  function sc_bootstrap_grid_news_cat_8(){
  
    $template = "
        <!-- News Grid Menu for category id=8 -->
        {MENU: path=news/news_grid&limit=2&category=8&source=latest&featured=0&layout=news-grid-7}
  ...
  function sc_bootstrap_grid_news_cat_9(){
  
    $template = "
        <!-- News Grid Menu for category id=9 -->
        {MENU: path=news/news_grid&limit=3&category=9&source=latest&featured=1&layout=news-grid-3}
